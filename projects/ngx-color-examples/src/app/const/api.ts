export const api = {
  directive: {
    input: [
      ...
      {
        name: 'attachTo',
        description: 'Set the element(ID) to append the overlay, Default is body'
      },
      {
        name: 'attachTo',
        description: 'Set the element(ID) to append the overlay, Default is body'
    ...
    output: [
      ...
      {
        name: 'slider',
        description: 'Gets triggered when the the alpha, hue or Lightness sliders are changed'
      },
      {
        name: 'open',
